          ...
          <Card key={i} className="animate-pulse">
            <CardContent className="pt-6">
              <div className="flex space-x-4">
                ...
                <div className="flex-1 space-y-3">
                  <div className="bg-gray-300 dark:bg-gray-600 h-4 w-1/3 rounded"></div>
...
const UserProfile = ({ username }) => {
  ...
  if (loading) {
    return (
      <div className="max-w-4xl mx-auto py-6 px-4">
        <div className="animate-pulse">
          <div className="bg-gray-300 dark:bg-gray-600 h-32 w-full rounded-lg mb-4"></div>
          <div className="flex items-center space-x-4">
      ...
      {activeTab === 'about' && (
        <Card>
          <CardContent className="p-6">
            ...
            {profileUser.links && profileUser.links.length > 0 && (
              <div className="mt-6">
                <h4 className="font-medium mb-2">{t('profile.links')}</h4>
                <div className="space-y-1">
                  {profileUser.links.map((link, index) => (
                    <a 
                      key={index}
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="text-2xl font-bold bg-gradient-to-r from-purple-600 to-pink-500 bg-clip-text text-transparent mb-4">
              krafink
            </div>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              {language === 'en' 
                ? 'The social network for artists and crafters. Showcase your work, connect with creators, and build your community.'
                : 'Das soziale Netzwerk für Künstler und Handwerker. Präsentieren Sie Ihre Arbeit, vernetzen Sie sich mit Kreativen und bauen Sie Ihre Community auf.'
              }
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              <Link to="/terms" className="block text-gray-600 dark:text-gray-400 hover:text-purple-600 dark:hover:text-purple-400">
                {t('legal.terms')}
              </Link>
              <Link to="/privacy" className="block text-gray-600 dark:text-gray-400 hover:text-purple-600 dark:hover:text-purple-400">
                {t('legal.privacy')}
              </Link>
              <Link to="/imprint" className="block text-gray-600 dark:text-gray-400 hover:text-purple-600 dark:hover:text-purple-400">
                {t('legal.imprint')}
              </Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              <Link to="/explore" className="block text-gray-600 dark:text-gray-400 hover:text-purple-600 dark:hover:text-purple-400">
                {t('nav.explore')}
              </Link>
              <Link to="/search" className="block text-gray-600 dark:text-gray-400 hover:text-purple-600 dark:hover:text-purple-400">
                {t('nav.search')}
              </Link>
            </div>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 dark:text-gray-400 text-sm">
            © 2025 krafink. All rights reserved.
          </p>
...
const AppContent = () => {
  ...
  const isAppRoute = ['/feed', '/explore', '/search', '/messages', '/notifications', '/compose'].includes(location.pathname) || 
